...
// import '../SlickSlider/SlickSlider.scss';
...
//                 <AiFillHeart style={{ color: '#73d2e6' }} />
//                 <AiFillHeart style={{ color: '#73d2e6' }} />
//                 <AiFillHeart style={{ color: '#73d2e6' }} />
//                 <AiFillHeart style={{ color: '#73d2e6' }} />
...
//                 <AtcBtn btnName="ADD TO BAD" price={element.price} />
//               </div>
...
//                 {/* <h2>
//                   John Deo <span className="job-title">UI Devloper</span>
//                 </h2> */}
//               </div>
//             </div>
//           );
...
//         <div className="card">
//           <div className="card-image">
//             <img src="https://cdn11.bigcommerce.com/s-9p889rxpkb/images/stencil/800w/products/434/1543/Bundle_6__LS_Body_Butter_Grapefruit_Body_Butter_Blood_Orange_Body_Butter_Naked_Body_Butter_all_full_size_200_ML_1__10748.1659723177.jpg" alt="a" />
//           </div>
//           <ul className="social-icons">
//             <li>
//               <a href="abc">
...
//         <div className="card">
//           <div className="card-image">
//             <img src="https://cdn11.bigcommerce.com/s-9p889rxpkb/images/stencil/800w/products/477/1567/Deluxe_Spa_Facial_Set_Product_Contents__71216.1669050157.jpg" alt="2" />
//           </div>
//           <ul className="social-icons">
//             <li>
//               <a href="abc">
...
//         <div className="card">
//           <div className="card-image">
//             <img src="https://cdn11.bigcommerce.com/s-9p889rxpkb/images/stencil/800w/products/430/1333/Bundle_1__LS_Soapy_Suds_LS_Body_Butter__71793.1643933135.jpg" alt="3" />
//           </div>
//           <ul className="social-icons">
//             <li>
//               <a href="abc">
        ...
        <div className="card">
          ...
          <div className="details">
            <h2>
              ...
              <AtcBtn  btnName="ADD TO CART" price={48}/>
              {/* <h2>Butter Together Body Butter Set</h2>
            <p>Limited-Edition Pride Block Star Set</p>  */}
            </h2>
          </div>
        ...
        <div className="card">
          ...
          <div className="details">
            ...
            Deluxe Spa Facial Holiday Set
              ...
              <AtcBtn  btnName="ADD TO CART" price={25}/>
              {/* <h2>Butter Together Body Butter Set</h2>
            <p>Limited-Edition Pride Block Star Set</p>  */}
            </h2>
          </div>
        ...
        <div className="card">
          ...
          <div className="details">
            ...
            Lemon Love Duo
              ...
              <AtcBtn  btnName="ADD TO CART" price={24}/>
              {/* <h2>Butter Together Body Butter Set</h2>
            <p>Limited-Edition Pride Block Star Set</p>  */}
            </h2>
          </div>
